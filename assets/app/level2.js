...
let checkOpt = (e) => {
    ...
    if (i == 15) {
        ...
        l2clear.innerHTML = `Parabéns!!! <br> você completou o nível 2, sua pontuação final foi: ${points.innerText}, se você quiser tentar novamente, recarregue a página ou clique nesta caixa`;
